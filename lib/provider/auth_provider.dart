...
import 'package:ecommer_user_side/auth/auth_firebase.dart';
import 'package:ecommer_user_side/helper/shared_helper.dart';
import 'package:ecommer_user_side/models/user_model.dart';
import 'package:ecommer_user_side/repo/firestore_auth_client.dart';
import 'package:ecommer_user_side/repo/firestore_auth_repositories.dart';
...
class AuthProvider extends ChangeNotifier {
  ...
  loginUsingGmail(BuildContext context) async {
    FirebaseUser users = await FbAuth.auth.loginUsingGmail();
  ...
  Future<FirebaseUser> loginUsingEmailAndPassword(BuildContext context) async {
    FirebaseUser users =
  ...
  Future<FirebaseUser> registerUsingEmailAndPassword(
    ...
    FirebaseUser user = await FbAuth.auth
